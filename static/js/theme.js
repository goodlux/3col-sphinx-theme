...
window.utilities = {
  ...
  headersHeight: function() {
    if (document.getElementById("cleartext-left-menu").classList.contains("make-fixed")) {
      return document.getElementById("cleartext-page-level-bar").offsetHeight;
    } else {
      return document.getElementById("header-holder").offsetHeight +
             document.getElementById("cleartext-page-level-bar").offsetHeight;
    }
  },
...
var cookieBanner = {
  ...
  cookieExists: function() {
    var cookie = localStorage.getItem("returningcleartextUser");
  ...
  setCookie: function() {
    localStorage.setItem("returningcleartextUser", true);
  },
...
window.highlightNavigation = {
  navigationListItems: document.querySelectorAll("#cleartext-right-menu li"),
  sections: document.querySelectorAll(".cleartext-article .section"),
  ...
  bind: function() {
    ...
    for (var i = 0; i < highlightNavigation.sections.length; i++) {
      ...
      highlightNavigation.sectionIdTonavigationLink[id] =
        document.querySelectorAll('#cleartext-right-menu li a[href="#' + id + '"]')[0];
    }
  ...
  highlight: function() {
    var rightMenu = document.getElementById("cleartext-right-menu");
    ...
    for (var i = (sections.length - 1); i >= 0; i--) {
      ...
      if (scrollPosition >= sectionTop - offset) {
        ...
        if (navigationListItem && !navigationListItem.classList.contains("active")) {
          ...
          // var menuTop = $("#cleartext-right-menu").position().top;
          // var itemTop = navigationListItem.getBoundingClientRect().top;
          // var TOP_PADDING = 20
          // var newActiveTop = $("#cleartext-side-scroll-right").scrollTop() + itemTop - menuTop - TOP_PADDING;

          // $("#cleartext-side-scroll-right").animate({
  ...
  bind: function() {
    $("[data-behavior='toggle-table-of-contents']").on("click", function(e) {
      ...
      if ($parent.hasClass("is-open")) {
        ...
        $(".cleartext-left-menu").slideUp(200, function() {
          $(this).css({display: ""});
        });
      } else {
        $parent.addClass("is-open");
        $(".cleartext-left-menu").slideDown(200);
      }
    });
  }
}
...
window.cleartextAnchors = {
  bind: function() {
    // Replace Sphinx-generated anchors with anchorjs ones
    $(".headerlink").text("");

    window.anchors.add(".cleartext-article .headerlink");
  ...
  bind: function() {
    ...
    var anchorScrolls = {
      ...
      init: function() {
        ...
        $('body').on('click', '#cleartext-right-menu li span', $.proxy(this, 'delegateSpans'));
      },
...
window.sideMenus = {
  rightMenuIsOnScreen: function() {
    return document.getElementById("cleartext-content-right").offsetParent !== null;
  },
  ...
  bind: function() {
    ...
    var rightMenuLinks = document.querySelectorAll("#cleartext-right-menu li");
    ...
    if (rightMenuHasLinks) {
      ...
      var titleLinks = document.querySelectorAll(
        "#cleartext-right-menu #cleartext-side-scroll-right \
      ...
      var menuLinks = document.querySelectorAll(
        "#cleartext-right-menu ul li ul li a.reference.internal"
      );
      ...
      var linkWithHash =
        document.querySelector(
          "#cleartext-right-menu a[href=\"" + window.location.hash + "\"]"
        );
      ...
      $("#cleartext-right-menu a.reference.internal").on("click", function() {
  ...
  leftMenuIsFixed: function() {
    return document.getElementById("cleartext-left-menu").classList.contains("make-fixed");
  },
  ...
  handleNavBar: function() {
    ...
    if (utilities.scrollTop() >= mainHeaderHeight) {
      document.getElementById("cleartext-left-menu").classList.add("make-fixed");
      document.getElementById("cleartext-page-level-bar").classList.add("left-menu-is-fixed");
    } else {
      document.getElementById("cleartext-left-menu").classList.remove("make-fixed");
      document.getElementById("cleartext-page-level-bar").classList.remove("left-menu-is-fixed");
    }
  },
  ...
  handleLeftMenu: function () {
    ...
    if (topOfFooterRelativeToWindow >= windowHeight) {
      document.getElementById("cleartext-left-menu").style.height = "100%";
    } else {
      ...
      document.getElementById("cleartext-left-menu").style.height = (windowHeight - leftMenuDifference) + "px";
    }
  },

  handleRightMenu: function() {
    var rightMenuWrapper = document.getElementById("cleartext-content-right");
    var rightMenu = document.getElementById("cleartext-right-menu");
    var rightMenuList = rightMenu.getElementsByTagName("ul")[0];
    var article = document.getElementById("cleartext-article");
    ...
    var rightMenuSideScroll = document.getElementById("cleartext-side-scroll-right");
...
},{}],"cleartext-sphinx-theme":[function(require,module,exports){
...
function ThemeNav () {
    ...
    nav.init = function ($) {
        ...
        this.navBar = $('div.cleartext-side-scroll:first');
        this.win = $(window);

        // Set up javascript UX bits
        $(document)
            // Shift nav in mobile when clicking the menu.
            .on('click', "[data-toggle='cleartext-left-menu-nav-top']", function() {
                $("[data-toggle='wy-nav-shift']").toggleClass("shift");
                $("[data-toggle='rst-versions']").toggleClass("shift");
            })

            // Nav menu link click operations
            .on('click', ".cleartext-menu-vertical .current ul li a", function() {
                var target = $(this);
        ...
        $('.cleartext-menu-vertical ul').not('.simple').siblings('a').each(function () {
            var link = $(this);
    ...
    nav.reset = function () {
        ...
        try {
            var vmenu = $('.cleartext-menu-vertical');
            ...
            if (link.length > 0) {
                $('.cleartext-menu-vertical .current').removeClass('current');
...
if (downloadNote.length >= 1) {
    ...
    var githubLink = "https://github.com/cleartext/tutorials/blob/master/" + tutorialUrlArray.join("/") + ".py",
        notebookLink = $(".reference.download")[1].href,
        notebookDownloadPath = notebookLink.split('_downloads')[1].split('/').pop(),
        colabLink = "https://colab.research.google.com/github/cleartext/tutorials/blob/gh-pages/_downloads/" + notebookDownloadPath;
    ...
    $(".cleartext-call-to-action-links").hide();
}

},{"jquery":"jquery"}]},{},[1,2,3,4,5,6,7,8,9,"cleartext-sphinx-theme"]);
